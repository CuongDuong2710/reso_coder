...
import 'package:nosql_database/data/fruit.dart';
import 'package:nosql_database/fruit_bloc/bloc.dart';
...
class _HomePageState extends State<HomePage> {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                trailing: _buildUpdateAndDeleteButton(displayedFruit),
              );
            },
          );
        }
  ...
  Row _buildUpdateAndDeleteButton(Fruit displayedFruit) {
    return Row(
