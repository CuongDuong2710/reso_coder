...
class _$BuiltVehicleSerializer implements StructuredSerializer<BuiltVehicle> {
  ...
  Iterable serialize(Serializers serializers, BuiltVehicle object,
    ...
    if (object.someValueNullable != null) {
      result
        ..add('someValueNullable')
        ..add(serializers.serialize(object.someValueNullable,
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'price':
          ...
          break;
        case 'someValueNullable':
          result.someValueNullable = serializers.deserialize(value,
